...
public final class DailogbuyBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public static DailogbuyBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static DailogbuyBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.dailogbuy, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static DailogbuyBinding bind(@NonNull View rootView) {
