...
public class payinActivity extends AppCompatActivity implements PaymentResultListener {
    private static final String TAG = payinActivity.class.getSimpleName();
